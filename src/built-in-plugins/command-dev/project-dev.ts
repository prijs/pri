...
export const projectDev = async (instance: typeof pri, options: any) => {
...
const debugProject = async (instance: typeof pri) => {
...
function debugProjectPrepare(instance: typeof pri, dashboardClientPort: number) {
